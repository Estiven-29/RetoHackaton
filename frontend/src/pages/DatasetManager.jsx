...
import { Database, Trash2, BarChart3, Calendar, Hash, CheckCircle } from 'lucide-react';
...
const DatasetManager = () => {
  ...
  const handleSetActive = (dataset) => {
    setActiveDataset(dataset.id, dataset);
    alert(`Dataset "${dataset.original_name}" activado.\n\nAhora el dashboard y todas las páginas mostrarán estos datos.`);
    navigate('/');
  };
